...
### 4 Final model
The diminishing accuracy rate as less and less variables are included in the model decreases most significantly when only the 4 most significant variables are used. However, using just the 7 most important variables and fitting a 5-fold cross validation model yields excellent results in terms of OOB error estimate and final predicting accuracy, while being very efficient in terms of computing power.
