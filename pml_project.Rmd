...
# Compare model results against actual results
table(predict(tree_fit, training), # Rows
...
rf_26_fit <- train(classe ~ . , data=training_25, method = "rf")

# Confusion matrix
confusionMatrix(predict(rf_26_fit, training_25),
      training_26$classe)
...
rf_13_fit <- train(classe ~ . , data=training_25, method = "rf")
rf_13_fit

# Confusion matrix
confusionMatrix(predict(rf_13_fit, training_25),
      training_13$classe)
...
# Standard bootstrapped random forest
